...
pub struct FungibleToken {
    ...
    //used to lock xp from transfers
    pub approved_transfer: LookupMap<AccountId, Balance>,
}

impl FungibleToken {
    pub fn new<S, A>(prefix: S, approval_prefix: A) -> Self
    where
        S: IntoStorageKey,
        A: IntoStorageKey,
    {
        let mut this = Self {
            ...
            approved_transfer: LookupMap::new(approval_prefix),
        };
    ...
    fn internal_transfer(
        ...
        self.approved_transfer.remove(&sender_id);
    }
